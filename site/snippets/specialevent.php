<div class="relative py4 center mt3 mb3 overflow-hidden">
  <div class="date center bc-white m2 absolute left-0 top-0 relative z2">
    <h4 class="caps regular m0 line-height-1">
      <?php
       $dateMonth = strtotime($page->specialeventdate());
       echo date('M', $dateMonth);
      ?>
    </h4>
    <h2 class="caps regular m0">
      <?php
       $dateDay = strtotime($page->specialeventdate());
       echo date('d', $dateDay);
      ?>
    </h2>
  </div>
