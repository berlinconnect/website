<div class="relative full-width bg-bc-blue bc-white center py2 center-bg cover-bg" <?php if($image = $page->image('service.jpg')): ?>style="background-image: url(<?= $image->url() ?>)"<?php endif ?>>
  <div class="py4 relative z1">
    ...
    <p class="h3 lighter px1 sm-px2 col-inline col-12 md-col-8"><? $page->oursundaygatheringstext() ?>Located at Alexanderplatz in the heart of Berlin we meet at Haus Ungarn. We look forward to welcoming you and your family and friends this Sunday.</p>
    <h4 class="bold mt3 mb2 tiny-mb2"><? $page->servicetimes() ?>Service Times</h4>
