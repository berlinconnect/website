<li class="post <?= $post->size() ?> <?= $post->tags() ?> bg-dark-gray overflow-hidden animted wow fadeIn">
  <div class="flex flex-center full-height full-width absolute z4">
  ...
  <div class="absolute full-height left-0 top-0 full-width cover-bg center-bg bg-image" style="background-image: url(<?= $post->images()->first()->url(); ?>)"></div>
