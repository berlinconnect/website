<li class="post <?= $post->size() ?> <?= $post->tags() ?> bg-dark-gray overflow-hidden">
  ...
  <div class="absolute top-0 left-0 bottom-0 right-0 cover-bg bg-overlay-dark-gray"></div>

  <div class="table m-auto left-0 top-0 bottom-0 right-0 font-size-0 absolute center z2 content-container">
