...
<div class="flex flex-center relative py4 full-width cover-bg general-hero summer-hero">
  <div class="flex-auto z3 container center bc-white ">
      <div class="flex flex-auto mx-auto summer-logo"></div>
  </div>
  <div class="summer-pattern"></div>
</div>

<div class="full-width clearfix" style="background-color: #F9F18C;">
  <div class="md-p4 center caps letter-spacing-2 ">
    <p class="p0 m0 py3 px3 line-height-5 bold black">Summer is a great season<br>For us to speed up not slow down.<br>Let's keep loving, learning<br>and growning as we celebrate<br>Summer in the city together.</p>
    <!-- these images do not have to be dynamic -->

    <div class="social-links mb4 sm-mb0">
      <a href="<?= $site->facebooklink() ?>" class="display-inline mr2" onclick="_gaq.push(['_trackEvent', 'Social Link', 'Clicked', 'Facebook in Hero']);">
        <svg width="44px" height="44px" viewBox="0 0 44 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
            ...
            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                <g id="Imported-Layers" sketch:type="MSLayerGroup" transform="translate(-336.000000, 0.000000)" fill="#000000">
                    <path d="M358,0 C345.85,0 336,9.85 336,22 C336,34.15 345.85,44 358,44 C370.15,44 380,34.15 380,22 C380,9.85 370.15,0 358,0 L358,0 Z M358,42 C346.954,42 338,33.046 338,22 C338,10.955 346.954,2 358,2 C369.046,2 378,10.955 378,22 C378,33.046 369.046,42 358,42 L358,42 Z M359.988,17.25 C359.988,16.441 360.071,16.008 361.316,16.008 L362.979,16.008 L362.979,12.998 L360.317,12.998 C357.121,12.998 355.995,14.504 355.995,17.035 L355.995,18.99 L354.002,18.99 L354.002,22 L355.995,22 L355.995,31.002 L359.983,31.002 L359.983,22 L362.646,22 L362.999,18.99 L359.983,18.99 L359.988,17.25 L359.988,17.25 Z" id="facebook" sketch:type="MSShapeGroup"></path>
                </g>
            </g>
        </svg>
      </a>
      <a href="<?= $site->twitterlink() ?>" class="display-inline mr2" onclick="_gaq.push(['_trackEvent', 'Social Link', 'Clicked', 'Facebook in Hero']);">
        <svg width="44px" height="44px" viewBox="0 0 44 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
            ...
            <defs></defs>
            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                <g id="Imported-Layers" sketch:type="MSLayerGroup" transform="translate(-252.000000, 0.000000)" fill="#000000">
                    <path d="M274,0 C261.85,0 252,9.85 252,22 C252,34.15 261.85,44 274,44 C286.15,44 296,34.15 296,22 C296,9.85 286.15,0 274,0 L274,0 Z M274,42 C262.954,42 254,33.046 254,22 C254,10.955 262.954,2 274,2 C285.046,2 294,10.955 294,22 C294,33.046 285.046,42 274,42 L274,42 Z M284.447,14.297 C283.654,14.76 282.776,15.096 281.842,15.277 C281.094,14.492 280.027,14.002 278.847,14.002 C276.581,14.002 274.744,15.81 274.744,18.04 C274.744,18.356 274.779,18.664 274.85,18.961 C271.439,18.792 268.416,17.184 266.393,14.74 C266.039,15.338 265.837,16.03 265.837,16.771 C265.837,18.172 266.561,19.408 267.662,20.133 C266.99,20.111 266.357,19.93 265.804,19.627 C265.803,19.644 265.803,19.66 265.803,19.678 C265.803,21.635 267.218,23.267 269.095,23.639 C268.75,23.731 268.389,23.779 268.014,23.779 C267.75,23.779 267.492,23.754 267.242,23.707 C267.764,25.312 269.279,26.479 271.074,26.512 C269.67,27.596 267.901,28.24 265.978,28.24 C265.647,28.24 265.321,28.222 265,28.185 C266.816,29.33 268.973,29.999 271.29,29.999 C278.838,29.999 282.965,23.846 282.965,18.508 C282.965,18.333 282.961,18.159 282.953,17.986 C283.754,17.416 284.449,16.705 285,15.896 C284.264,16.217 283.474,16.434 282.644,16.531 C283.49,16.031 284.141,15.24 284.447,14.297 L284.447,14.297 Z" id="twitter" sketch:type="MSShapeGroup"></path>
                </g>
            </g>
        </svg>
      </a>
      <a href="<?= $site->instagramlink() ?>" class="display-inline mr2" onclick="_gaq.push(['_trackEvent', 'Social Link', 'Clicked', 'Facebook in Hero']);">
        <svg width="44px" height="44px" viewBox="0 0 44 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
            ...
            <defs></defs>
            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                <g id="Imported-Layers" sketch:type="MSLayerGroup" transform="translate(-252.000000, -84.000000)" fill="#000000">
                    <path d="M280,96 L268,96 C265.791,96 264,97.791 264,100 L264,112 C264,114.209 265.791,116 268,116 L280,116 C282.209,116 284,114.209 284,112 L284,100 C284,97.791 282.209,96 280,96 L280,96 Z M278,99 L281,99 L281,102 L278,102 L278,99 Z M274,102 C276.209,102 278,103.791 278,106 C278,108.209 276.209,110 274,110 C271.791,110 270,108.209 270,106 C270,103.791 271.791,102 274,102 L274,102 Z M282,112 C282,113.105 281.104,114 280,114 L268,114 C266.895,114 266,113.105 266,112 L266,105 L268.101,105 C268.046,105.327 268,105.658 268,106 C268,109.315 270.686,112 274,112 C277.313,112 280,109.315 280,106 C280,105.658 279.955,105.327 279.899,105 L282,105 L282,112 L282,112 Z M274,84 C261.85,84 252,93.85 252,106 C252,118.15 261.85,128 274,128 C286.15,128 296,118.15 296,106 C296,93.85 286.15,84 274,84 L274,84 Z M274,126 C262.954,126 254,117.046 254,106 C254,94.955 262.954,86 274,86 C285.046,86 294,94.955 294,106 C294,117.046 285.046,126 274,126 L274,126 Z" id="instagram" sketch:type="MSShapeGroup"></path>
                </g>
            </g>
        </svg>
      </a>
      <a href="<?= $site->tumblrlink() ?>" class="display-inline" onclick="_gaq.push(['_trackEvent', 'Social Link', 'Clicked', 'Tumblr in Hero']);">
        <svg width="44px" height="44px" viewBox="0 0 44 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
            <!-- Generator: Sketch 3.3.3 (12072) - http://www.bohemiancoding.com/sketch -->
            <title>tumblr</title>
            <desc>Created with Sketch.</desc>
            <defs></defs>
            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                <g id="Imported-Layers" sketch:type="MSLayerGroup" transform="translate(0.000000, -84.000000)" fill="#000000">
      ...
      <div class="flex-auto summer-event-content center">
        <div class="icon volly">
          <svg width="82px" height="82px" viewBox="0 0 82 82" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <defs></defs>
              <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g id="volleyball" transform="translate(1.000000, 1.000000)" stroke-width="2" stroke="#000000">
                      <g id="Layer_1">
                          <g id="Group">
        ...
        <h4 class="title caps">SUMMER MADNESS IN THE PARK</h4>
        <p class="h5 summer-date">7 &amp; 21JULY</p>
        <p class="h5 summer-location"><a class="black" href="https://goo.gl/maps/SD4ZAcTYBiK2">VOLKSPARK FRIEDRICHSHAIN</a></p>
      </div>
    </div>

    <div class="flex flex-center col-12 md-col-6 full-height cover-bg flex-content-stretch center-bg py4" style="background-color: #CCDFF3;">
      <div class="flex-auto summer-event-content center">
        <div class="icon hillsong">
          <svg width="32px" height="131px" viewBox="0 0 32 131" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <defs></defs>
              <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g id="conf" transform="translate(1.000000, 0.000000)" stroke-width="2" stroke="#000000">
                      <g id="Group">
        ...
        <h4 class="title caps">HILLSONG CONFERENCE</h4>
        <p class="h5 summer-date">27-29 JULY</p>
        <p class="h5 summer-location"><a class="black" href="https://goo.gl/maps/XLX1szBHpRC2">THE O2 LONDON</a></p>
      </div>
    </div>
  ...
  <div class="full-width py4 px3 black border-box" style="background-color: #F9F18C;">
    <div class="clearfix mt2 mb3 tiny-center sm-left md-left font-size-0">
      <div class="mx-auto col-2 sm-col-12 sm-center">
        <img class="inline-block  mb3 vm" src="<?php echo $site->url() ?>/images/logo/light-dark-gray.svg" width="70px"/>
      </div>
      <div class="col-inline col-12  sm-col-12 lg-col-4 md-center">
        <p>
          <?= $site->copyright()?>
          <br>
          <a href="/imprint" class="black"><?= $site->imprintlink()?></a>
        </p>
      </div>
      <div class="col-inline col-12 sm-col-12 lg-col-4 md-center">
        <p>
