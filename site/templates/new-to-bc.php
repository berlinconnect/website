...
<div class="full-width clearfix bg-bc-blue bc-white py4">
  <div class="container center py3 tiny-py1">
    ...
    <div class="mt3">
      <a href="<?= $page->emailaddress() ?>" class="button h5 caps bold p2 center bg-bc-white bc-blue" onclick="_gaq.push(['_trackEvent', 'Buttons', 'Clicked', 'Find us on a map']);"><?= $page->findus() ?></a>
    </div>
  </div>
</div>
<?php snippet('footer') ?>
