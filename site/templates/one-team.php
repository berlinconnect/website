...
<div class="full-width clearfix bg-bc-blue bc-white py3 mt3">
  <div class="container center py3 tiny-py1">
    ...
    <div class="mt3">
      <a href="<?= $page->brochurelink() ?>" class="h5 caps bold p2 center bg-bc-blue border border-bc-white bc-white" onclick="_gaq.push(['_trackEvent', 'Buttons', 'Clicked', 'Learn more about team']);"><?= $page->learnmorecalltoaction() ?></a>
